...
\def\lc@EnableCharForHl#1#2{\begingroup\typeout{#1:#2}%
\catcode`#2=\active
\begingroup\endlinechar-1
                     \everyeof{{\lc@colorvar{#1}{#2}\xspace}\endgroup}\scantokens{\gdef#2}}
...
\def\lc@close{%
   ...
   \ifcsname lc@lambdas\lc@lastbracket\endcsname
      ...
      \expandafter\@tfor\expandafter\@lc@ltarget\expandafter:\expandafter=\@tmp\do{%
         ...
         \tikz[overlay,remember picture]{\draw[lightgray!40!white!90!\@lc@color,thin,rounded corners=1.5pt] ([yshift=-5pt+0.75pt*\the\c@lc@bracketlevel]lc@\@lc@ltarget.south west) rectangle ([yshift=4pt-0.75pt*\the\c@lc@bracketlevel]lc@\the\c@lc@markerindex.north west);}%
      }%
