...
\usepackage[encoding,cpalette,defaultfont]{sopra-listings}
...
\lstdefinelanguage{lLambdaCalculus}{
   add to literate={:lambda:}{{{\ensuremath{\color{sol@colors@lst@keywordA}{\lambda}}}}}1
   {\\}{{{\ensuremath{\color{sol@colors@lst@keywordA}{\lambda}}}}\aftergroup\typeout}1
