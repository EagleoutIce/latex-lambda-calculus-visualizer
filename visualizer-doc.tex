...
\begin{document}
   ...
   \section{Shortcut and customization options}
      ...
      If you do not like the colors you can change their cycle locally with |\lcSetColors|: |{\lcSetColors{purple,orange}\LC{((\\a.\a) \\b.\b \a)}}| yields: {\lcSetColors{purple,orange}\LC{((\\a.\a) \\b.\b \a)}} (vs. \LC{((\\a.\a) \\b.\b \a)}).
