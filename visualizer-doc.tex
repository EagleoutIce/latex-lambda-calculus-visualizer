...
\end{lstlisting}
   ...
   So with |\lcCreateNewRewritingRule\cons{cons}{\\x y c\.\c \x \y}| you can now use |\cons| within your \(\lambda\)-calculus expressions. Therefore, \lcCreateNewRewritingRule\cons{cons}{\\x y c\.\c \x \y}|\LC{\\x.\cons \x}| yields: \LC{\\x.\cons \x}.
